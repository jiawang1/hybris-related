 ...
 *
 */
package com.tasly.anguo.storefront.interceptors;
...
import com.tasly.anguo.storefront.util.CSRFHandlerInterceptor;
import com.tasly.anguo.storefront.util.CSRFTokenManager;
...
{
	private final String SESSION_CSRF_ATTRIBUTE = "com.tasly.anguo.storefront.util.CSRFTokenManager.tokenval";
