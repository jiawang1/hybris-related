...
/**
 * This is the extension manager of the Anguoadmin extension.
 */
public class AnguoadminManager extends GeneratedAnguoadminManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AnguoadminManager.class.getName());
	 ...
	 */
	public static AnguoadminManager getInstance()
	{
		return (AnguoadminManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AnguoadminConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AnguoadminManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AnguoadminManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AnguoadminManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AnguoadminManager called, current tenant: " + getTenant().getTenantID());
		}
	}
