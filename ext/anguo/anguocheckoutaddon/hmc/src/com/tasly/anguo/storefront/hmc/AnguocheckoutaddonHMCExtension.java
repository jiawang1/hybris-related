 ...
 *
 */
package com.tasly.anguo.storefront.hmc;
...
/**
 * Provides necessary meta information about the anguocheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.2
 */
public class AnguocheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AnguocheckoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.tasly.anguo.storefront.hmc.locales";
