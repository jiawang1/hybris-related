 ...
 *
 */
package com.tasly.anguo.storefront.jalo;
...
import com.tasly.anguo.storefront.constants.AnguocheckoutaddonConstants;



/**
 * This is the extension manager of the Anguocheckoutaddon extension.
 */
public class AnguocheckoutaddonManager extends GeneratedAnguocheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AnguocheckoutaddonManager.class.getName());
	 ...
	 */
	public static AnguocheckoutaddonManager getInstance()
	{
		return (AnguocheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AnguocheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AnguocheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AnguocheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AnguocheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AnguocheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
