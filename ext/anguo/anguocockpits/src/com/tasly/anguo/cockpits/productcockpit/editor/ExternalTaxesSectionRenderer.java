 ...
 *
 */
package com.tasly.anguo.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("anguocockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("anguocockpits.product.externalTaxes"));
