 ...
 *
 */
package com.tasly.anguo.cockpits.setup;
...
import com.tasly.anguo.cockpits.constants.AnguoCockpitsConstants;
 ...
 */
@SystemSetup(extension = AnguoCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AnguoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AnguoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AnguoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/anguocockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
