 ...
 *
 */
package com.tasly.anguo.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AnguoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AnguoFulfilmentProcessConstants.PARENT_PROCESS);
