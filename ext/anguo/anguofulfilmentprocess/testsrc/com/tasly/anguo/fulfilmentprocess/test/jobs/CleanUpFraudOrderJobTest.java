 ...
 *
 */
package com.tasly.anguo.fulfilmentprocess.test.jobs;
...
import com.tasly.anguo.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AnguoFulfilmentProcessConstants.ORDER_PROCESS_NAME;
