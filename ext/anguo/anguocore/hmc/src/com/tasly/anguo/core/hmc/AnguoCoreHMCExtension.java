 ...
 *
 */
package com.tasly.anguo.core.hmc;
...
/**
 * Provides necessary meta information about the anguocore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AnguoCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AnguoCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.tasly.anguo.core.hmc.locales";
