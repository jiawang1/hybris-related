 ...
 *
 */
package com.tasly.anguo.test.setup;
...
import com.tasly.anguo.test.constants.AnguoTestConstants;
import com.tasly.anguo.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AnguoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/anguotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/anguotest/import/reviews.impex");
			...
			importImpexFile(context, "/anguotest/import/cstickets.impex");
		}
	}
}
